...
#ifndef ALAMOFIRERSSPARSER_SWIFT_H
#define ALAMOFIRERSSPARSER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AlamofireRSSParser",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// This class does the bulk of the work.  Implements the <code>NSXMLParserDelegate</code> protocol.
/// Unfortunately due to this it’s also required to implement the <code>NSObject</code> protocol.
...
/// a custom-created instance of this class with configuration properties set into <code>responseRSS</code> (see the commented out overload above)
SWIFT_CLASS("_TtC18AlamofireRSSParser18AlamofireRSSParser")
@interface AlamofireRSSParser : NSObject <NSXMLParserDelegate>
